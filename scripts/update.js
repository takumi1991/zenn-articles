...
Amazon Web Services の常時無料枠（Always Free Services）は、

アカウント作成後の12ヶ月間のみ利用できる無料枠（Free Tier）とは異なり、

**一定の使用量までは期限なく無料で利用できるサービス群**です。

完全に無制限で無料というわけではなく、

各サービスごとに定められた無料枠を超えた場合は従量課金が発生します。

本記事では、AWS公式が公開している常時無料対象サービスを一覧で整理しています。

個人開発・学習・コスト最適化の参考として活用してください。
